...
class Chart extends WriterPart
{
    ...
    public function writeChart(\PhpOffice\PhpSpreadsheet\Chart\Chart $chart, $calculateCellValues = true)
    {
        ...
        $this->writeView3D($objWriter, $chart->getRotX(), 'c:rotX', $surface2D, 35);
        $this->writeView3D($objWriter, $chart->getRotY(), 'c:rotY', $surface2D, 45);
        $this->writeView3D($objWriter, $chart->getRAngAx(), 'c:rAngAx', $surface2D, 0);
